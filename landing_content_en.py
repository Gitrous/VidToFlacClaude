...
PAGES_EN = [
    {
        ...
        "description":      "Convert the audio in your MP4 files to lossless FLAC in your browser with FFmpeg. Fixes the DaVinci Resolve audio codec error on camera and OBS files.",
  ...
  <section class="card seo-card" aria-labelledby="guia-formato-titulo">
    ...
    <article>
      ...
      <figure class="fig">
        <img src="/media/capturas/resolve-pista-sin-onda.webp" width="1200" height="144" loading="lazy" decoding="async" alt="An MP4 audio track with no waveform in the DaVinci Resolve timeline" />
        <figcaption>Our own screenshot: MP4 with AAC-LC audio in DaVinci Resolve Studio 21 on Ubuntu, with an empty track.</figcaption>
      </figure>
    ...
    },
    {
        ...
        "description":      "Convert the audio inside MKV files to lossless FLAC without re-encoding the video. Fixes silent OBS and screen recordings in DaVinci Resolve.",
  ...
  <section class="card seo-card" aria-labelledby="guia-formato-titulo">
    ...
    <article>
      ...
      <figure class="fig">
        <svg class="fig-svg" viewBox="0 0 660 344" width="660" height="344" role="img" aria-labelledby="cten cden" xmlns="http://www.w3.org/2000/svg"><title id="cten">Which audio codec each format carries, and which ones end up silent in DaVinci Resolve on Linux</title><desc id="cden">Table: MP4 and MOV carry AAC-LC, OBS MKV files AAC or Opus, WebM Opus or Vorbis, AVI MP3 or AC-3 and VOB AC-3, and all of them import without sound in DaVinci Resolve on Linux; WAV and AIFF with PCM and the converted MKV with FLAC do play.</desc><text x="20" y="40" font-family="JetBrains Mono, ui-monospace, monospace" font-size="10.5" letter-spacing="0.08em" fill="#66666e" text-anchor="start">SOURCE FORMAT</text><text x="230" y="40" font-family="JetBrains Mono, ui-monospace, monospace" font-size="10.5" letter-spacing="0.08em" fill="#66666e" text-anchor="start">USUAL AUDIO CODEC</text><text x="440" y="40" font-family="JetBrains Mono, ui-monospace, monospace" font-size="10.5" letter-spacing="0.08em" fill="#66666e" text-anchor="start">IN RESOLVE ON LINUX</text><line x1="20" y1="48" x2="640" y2="48" stroke="rgba(255,255,255,.12)"/><text x="20" y="74" font-family="Hanken Grotesk, system-ui, sans-serif" font-size="13.5" font-weight="600" fill="#f3f3ef">MP4 · MOV</text><text x="230" y="74" font-family="JetBrains Mono, ui-monospace, monospace" font-size="12" fill="#a7a7ad">AAC-LC</text><rect x="440" y="59" width="160" height="22" rx="11" fill="rgba(255,96,88,.1)" stroke="rgba(255,96,88,.55)"/><text x="520" y="74" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, monospace" font-size="11" fill="#ff8c86">no sound</text><line x1="20" y1="84" x2="640" y2="84" stroke="rgba(255,255,255,.055)"/><text x="20" y="108" font-family="Hanken Grotesk, system-ui, sans-serif" font-size="13.5" font-weight="600" fill="#f3f3ef">OBS MKV</text><text x="230" y="108" font-family="JetBrains Mono, ui-monospace, monospace" font-size="12" fill="#a7a7ad">AAC or Opus</text><rect x="440" y="93" width="160" height="22" rx="11" fill="rgba(255,96,88,.1)" stroke="rgba(255,96,88,.55)"/><text x="520" y="108" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, monospace" font-size="11" fill="#ff8c86">no sound</text><line x1="20" y1="118" x2="640" y2="118" stroke="rgba(255,255,255,.055)"/><text x="20" y="142" font-family="Hanken Grotesk, system-ui, sans-serif" font-size="13.5" font-weight="600" fill="#f3f3ef">WebM</text><text x="230" y="142" font-family="JetBrains Mono, ui-monospace, monospace" font-size="12" fill="#a7a7ad">Opus or Vorbis</text><rect x="440" y="127" width="160" height="22" rx="11" fill="rgba(255,96,88,.1)" stroke="rgba(255,96,88,.55)"/><text x="520" y="142" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, monospace" font-size="11" fill="#ff8c86">no sound</text><line x1="20" y1="152" x2="640" y2="152" stroke="rgba(255,255,255,.055)"/><text x="20" y="176" font-family="Hanken Grotesk, system-ui, sans-serif" font-size="13.5" font-weight="600" fill="#f3f3ef">Old AVI</text><text x="230" y="176" font-family="JetBrains Mono, ui-monospace, monospace" font-size="12" fill="#a7a7ad">MP3 or AC-3</text><rect x="440" y="161" width="160" height="22" rx="11" fill="rgba(255,96,88,.1)" stroke="rgba(255,96,88,.55)"/><text x="520" y="176" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, monospace" font-size="11" fill="#ff8c86">no sound</text><line x1="20" y1="186" x2="640" y2="186" stroke="rgba(255,255,255,.055)"/><text x="20" y="210" font-family="Hanken Grotesk, system-ui, sans-serif" font-size="13.5" font-weight="600" fill="#f3f3ef">DVD VOB</text><text x="230" y="210" font-family="JetBrains Mono, ui-monospace, monospace" font-size="12" fill="#a7a7ad">AC-3</text><rect x="440" y="195" width="160" height="22" rx="11" fill="rgba(255,96,88,.1)" stroke="rgba(255,96,88,.55)"/><text x="520" y="210" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, monospace" font-size="11" fill="#ff8c86">no sound</text><line x1="20" y1="220" x2="640" y2="220" stroke="rgba(255,255,255,.055)"/><text x="20" y="244" font-family="Hanken Grotesk, system-ui, sans-serif" font-size="13.5" font-weight="600" fill="#f3f3ef">WAV · AIFF</text><text x="230" y="244" font-family="JetBrains Mono, ui-monospace, monospace" font-size="12" fill="#a7a7ad">PCM</text><rect x="440" y="229" width="160" height="22" rx="11" fill="rgba(25,195,125,.12)" stroke="#19c37d"/><text x="520" y="244" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, monospace" font-size="11" fill="#4ee6a8">Resolve reads it</text><line x1="20" y1="254" x2="640" y2="254" stroke="rgba(255,255,255,.055)"/><text x="20" y="278" font-family="Hanken Grotesk, system-ui, sans-serif" font-size="13.5" font-weight="600" fill="#f3f3ef">Converted MKV</text><text x="230" y="278" font-family="JetBrains Mono, ui-monospace, monospace" font-size="12" fill="#a7a7ad">FLAC</text><rect x="440" y="263" width="160" height="22" rx="11" fill="rgba(25,195,125,.12)" stroke="#19c37d"/><text x="520" y="278" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, monospace" font-size="11" fill="#4ee6a8">Resolve reads it</text><text x="20" y="304" font-family="Hanken Grotesk, system-ui, sans-serif" font-size="12" fill="#a7a7ad">Tested in DaVinci Resolve Studio 21 on Ubuntu, September 2026.</text><text x="20" y="321" font-family="Hanken Grotesk, system-ui, sans-serif" font-size="12" fill="#a7a7ad">On Windows and macOS, AAC and MP3 usually work; the rest stays uneven.</text></svg>
        <figcaption>The usual audio codec in each format and what it does in DaVinci Resolve on Linux.</figcaption>
      </figure>
    ...
    },
    {
        ...
        "description":      "Convert the audio in MOV files from iPhone, GoPro or a camera to lossless FLAC. Fixes the DaVinci Resolve audio codec error, right in your browser.",
  ...
  <section class="card seo-card" aria-labelledby="guia-formato-titulo">
    ...
    <article>
      ...
      <figure class="fig">
        <img src="/media/capturas/resolve-forma-de-onda.webp" width="1200" height="144" loading="lazy" decoding="async" alt="Audio track showing its waveform after the file was converted" />
        <figcaption>The same clip with its audio already in FLAC: the waveform appears and the sound plays.</figcaption>
      </figure>
  ...
  <section class="card seo-card" aria-labelledby="guia-formato-titulo">
    ...
    <article>
      ...
      <figure class="fig">
        ...
        <figcaption>With a WAV there is no video to copy: only the audio is re-encoded, and FLAC keeps every sample.</figcaption>
      </figure>
