...
MERGED_ES = [
    {
        ...
        "description":      "Guía de nueve formatos de vídeo —AVI, WebM, WMV, FLV, MPEG, TS, VOB, 3GP y M4V—: qué códec de audio llevan, por qué DaVinci Resolve no lo lee y cómo pasarlo a FLAC en tu navegador.",
    ...
    },
    {
        ...
        "description":      "Guía de siete formatos de audio —MP3, AAC, M4A, AIFF, OGG, Opus y WMA—: por qué tu editor no los lee, qué ganas y qué no al pasarlos a FLAC, y cómo hacerlo en tu navegador.",
...
MERGED_EN = [
    {
        ...
        "description":      "A guide to nine video formats (AVI, WebM, WMV, FLV, MPEG, TS, VOB, 3GP and M4V): which audio codec each one carries, why DaVinci Resolve will not read it, and how to turn it into FLAC in your browser.",
    ...
    },
    {
        ...
        "description":      "A guide to seven audio formats (MP3, AAC, M4A, AIFF, OGG, Opus and WMA): why your editor will not read them, what you do and do not gain by turning them into FLAC, and how to do it in your browser.",
